# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-12-29 18:37
from __future__ import unicode_literals

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import mediaide_app.manager
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', mediaide_app.manager.UserManager()),
            ],
        ),
        migrations.CreateModel(
            name='ContactUs',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('treatment_package', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mediaide_app.MedicalPackages')),
